...
function EducationInformationFormUnit({ onSave, onCancel, onDelete, onToggleIsFormOpen, inputValues, onUpdateInputValues }) {
    return (
        <div className="education-information-form-container">
            <div onClick={onToggleIsFormOpen} className="education-information-header-container">
