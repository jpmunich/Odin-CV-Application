        ...
        <div className="personal-information-form-container">
            ...
            <form action="#">
                ...
                <div className='personal-information-input-container'>
                    <input value={personalInfo.name} onChange={onChange} 
                        id="name" 
                        name="name" 
                        type="text" 
                ...
                <div className='personal-information-input-container'>
                    <input value={personalInfo.email} onChange={onChange} 
                        id="email" 
                        name="email" 
                        type="text" 
                ...
                <div className='personal-information-input-container'>
                    <input value={personalInfo.location}  onChange={onChange} 
                        className="bottom-of-form-input" id="location" 
                        name="location" 
                        type="text" 
